<template>
  <rt-fullscreen-image background-image="/static/images/homeinternet/homeinternet-image5.jpg" background-position="top">
        ...
        <div class="rt-col-12">
          ...
          <div class="row row--mobile-scroll rt-space-top4 rt-font-hypnens-off">
                        ...
                        <svg width="56px" height="56px" viewBox="0 0 56 56" version="1.1" xmlns="http://www.w3.org/2000/svg">
                          <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="internet">
                              <g id="Group-5">
                                <g id="Fill-35">
                                  <path d="M55.3521,28.4589 C55.3521,43.6469 43.0391,55.9589 27.8521,55.9589 C12.6641,55.9589 0.3521,43.6469 0.3521,28.4589 C0.3521,13.2709 12.6641,0.9589 27.8521,0.9589 C43.0391,0.9589 55.3521,13.2709 55.3521,28.4589" fill="#FF5F4B" fill-rule="evenodd" />
                                  ...
                                  <path id="Stroke-168" d="M40.6899,34.8915 L14.7429,20.3755" stroke="#FFFFFF" stroke-width="1" stroke-linejoin="round" />
                                  <path id="Stroke-169" d="M38.7627,39.2968 L14.7427,25.4628" stroke="#FFFFFF" stroke-width="1" stroke-linejoin="round" />
                                </g>
                              </g>
                            </g>
                          </g>
            ...
            <div class="rt-col-6 rt-col-md-3 d-md-flex-column">
              ...
              <p class="color-white05 rt-space-top rt-font-label rt-space-left"><span class="rt-font-sup">2</span> стоимость продукта 2 на сайте ООО «ИСЕТ Софтвеа»</p>
            </div>
          </div>
        </div>
      </div>
