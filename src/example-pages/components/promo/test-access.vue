        ...
        <rt-slide>
          <rt-card :has-label="true" :equal-padding="true" label-main-color="b2c-purple" label-font-size="14px">
            ...
            <template slot="popup-special-benefits">
              <div class="a-p__popup-benefit rt-space-bottom25">
                <p class="rt-font-h4 rt-font-bold">Контроль за работой</p>
              ...
              <div class="a-p__popup-benefit rt-space-bottom25">
                <p class="rt-font-h4 rt-font-bold">Экономия времени операторов</p>
              ...
              <div class="a-p__popup-benefit rt-space-bottom25">
                <p class="rt-font-h4 rt-font-bold">Без лишних трат</p>
    ...
    <rt-real-popup :position-center="true" class="a-p__popup">
      <template>
        <rt-scroll-bar ref="ScrollBar">
          ...
          <div class="color-block--light-grey rt-space-top2 rt-space-bottom25 rt-space-horizontal">
