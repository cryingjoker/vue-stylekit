  ...
  <div class="rt-l-game color-block--game-promo-color">
    ...
    <rt-banner :sleep-time=30000 :is-fullscreen-image="true" content-height="470px" :is-background-banner="true"
      ...
      <rt-banner-item is-game-banner-item
                      contnent-height="470px"
                      background-video="/static/video/Trailer_Warface_Annoucement_20180628_4000.mp4"
    ...
    <div class="rt-container rt-space-top2 rt-dark-theme rt-dark-theme--transparent rt-space-bottom2">
      ...
      <div class="rt-space-top135 flex-end-center">
        <rt-logo class="rt-layer-level-4 relative d-inline-block promo-wargame-logo" width="300px" height="93px"
                 type="game-logo"></rt-logo>
      </div>
      <div class="rt-space-top25">
        <div class="d-flex row rt-td-space-horizontal">
          <div class="rt-col-5 rt-col-td-6">
            <rt-color-line-text
              fill-color="orange"
              color-icon="white"
              :is-white-color="true"
          ...
          <div class="rt-col-6 rt-col-td-6 rt-td-space-top15 rt-td-space-bottom15 rt-md-space-bottom3">
            <div class="rt-space-bottom4 rt-td-space-bottom-none">
            ...
            <div class="d-none md-d-block rt-space-top2">
              <rt-button class="rt-button-orange rt-button-small rt-button--is-block">Подключить</rt-button>
            </div>
          </div>
        </div>
      </div>

      <div class="row td-flex-column-reverse rt-td-space-horizontal">
        <div class="rt-col-5 rt-col-td-6">
          <div class="rt-space-top25">
            ...
            <rt-tabs>
              ...
              <template slot="content">
                <rt-tabs-content-item
                  ...
                  <div class="rt-space-top3">
                    <p class="rt-font-paragraph rt-font-bold color-white07"> А еще я хочу подключить по выгодной
                      цене:</p>
                  </div>
                  <div class="rt-space-top">
                    <rt-switch class="switch--orange rt-font-control">Терминал ONT без Wi-Fi <br> +20₽ в месяц
                    </rt-switch>
                  </div>
                  <div class="rt-space-top">
                    <rt-switch class="switch--orange rt-font-control">Терминал ONT без Wi-Fi <br> +20₽ в месяц
                  ...
                  <div class="rt-space-top md-d-none">
                ...
                <rt-tabs-content-item
                  ...
                  <div class="rt-space-top rt-space-bottom2">
                    <p class="color-white05 rt-font-small-paragraph">Если у Вас нет аккаунта в Ростелеком, его
                      необходимо
        ...
        <div class="rt-col-6 rt-col-td-6">
          <div class="rt-space-top4 rt-td-space-top">
            <p class="rt-font-h2 rt-font-medium">Игровая опция Warface</p>
            <div class="rt-space-top15 rt-td-space-top2">
              <div class="row rt-space-bottom3 rt-md-space-bottom-none">
                <div class="rt-col-6 rt-font-center rt-col-td-2 rt-col-md-3">
                  <img style="max-height: 126px; max-width:100%" src="/static/images/game/warface1.png" alt=""/>
                </div>
                <div class="rt-col-6 rt-col-td-4 rt-md-space-top rt-col-md-3">
                  <p>Крутые пушки всем абонентам</p>
                  <p class="color-white05 rt-space-top05">Пока подключена игровая опция Warface пользуйся любой из
                    четырех пушек. Тип оружия можно изменять каждые 24 часа в личном кабинете на wf.mail.ru</p>
                </div>
              </div>
              <div class="row rt-space-top2 rt-space-bottom3 rt-md-space-bottom-none">
                <div class="rt-col-6 rt-font-center rt-col-td-2 rt-col-md-3">
                  <img style="max-height: 126px; max-width:100%" src="/static/images/game/warface2.png" alt=""/>
                </div>
                <div class="rt-col-6 rt-col-td-4 rt-md-space-top rt-col-md-3">
                  <p>Кредиты каждый день</p>
                  <p class="color-white05 rt-space-top05">Получай кредиты в подарок просто за то, что оплатил тариф
                    «Игровой» в этом месяце! Кредиты начисляются ежедневно, пока активна игровая опция</p>
                </div>
              </div>
              <div class="row rt-space-top2">
                <div class="rt-col-6 rt-font-center rt-col-td-2 rt-col-md-3">
                  <img style="max-height: 126px; max-width:100%" src="/static/images/game/warface3.png" alt=""/>
                </div>
                <div class="rt-col-6 rt-col-td-4 rt-md-space-top rt-col-md-3">
                  <p>Оружие навсегда</p>
                  <p class="color-white05 rt-space-top05">Мечтаешь об отличной пушке, которая навсегда останется на
                    твоем складе? Накопи дни РТК и обменяй их на постоянное оружие!</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="color-block--white rt-space-top25 color-dark">
      <div class="rt-container">
        ...
        <p class="rt-font-control rt-space-top05 color-main05 rt-font-light">Warface — игровая опция (Опция) Услуги
          ...
          <div class="rt-col-8 rt-col-td-6">
            <rt-slide-content>
              ...
              <template slot="content">
                ...
                предоставление доступа к сети интернет по технологии xDSL. Тарифы — в разделе</span>
              </template>
            </rt-slide-content>
            <rt-slide-content>
              <template slot="label">Зачем мне нужна регистрация в личном кабинете?</template>
