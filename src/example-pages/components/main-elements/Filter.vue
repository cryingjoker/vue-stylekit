          ...
          <div class="row">
            <div class="rt-col-8 rt-col-td-6 rt-col-md-3">
                ...
                <rt-resize-content-height
                  ...
                  <rt-filter-watcher :options="['creator','count','subscription']"
                                     :values="[['kaspersky','drweb'],'1','only month']"
                                     :group-size="2"
                                     class="rt-col-6 rt-col-md-3 rt-space-bottom">
                    <rt-card>
                  ...
                  <rt-filter-watcher :options="['creator','count','subscription']"
                                     :values="[['kaspersky','drweb'],'less than 3','only month']"
                    ...
                    <rt-card>
                      ...
                      <template slot="content">
                        ...
                        <p class="rt-space-top color-main07 rt-space-right2">
                          Надежное и удобное решение для защиты вашей жизни в интернете, которое включает в себя
                  ...
                  <rt-filter-watcher :options="['creator','count','subscription']"
                                     :values="[['kaspersky','drweb'],'less than 3','not month']"
                                     class="rt-col-6 rt-space-bottom rt-col-md-3">
                    <rt-card>
                      <template slot="header">
                        <img class="rt-card__header__image" src="/sites/default/files/img/logo/Kaspersky_color.svg"/>
                  ...
                  <rt-filter-watcher :options="['creator','count','subscription']"
                                     :values="['kaspersky','less than 4','only month']"
                                     class="rt-col-6 rt-space-bottom rt-col-md-3">
                    <rt-card>
                      <template slot="header">
                        <img class="rt-card__header__image" src="/sites/default/files/img/logo/Kaspersky_color.svg"/>
                  ...
                  <rt-filter-watcher :options="['creator','count','subscription']" :values="['drweb','1','only month']"
                                     class="rt-col-6 rt-space-bottom rt-col-md-3">
                    <rt-card>
                      <template slot="header">
                  ...
                  <rt-filter-watcher :options="['creator','count','subscription']" :values="['drweb','1','not month']"
                                     class="rt-col-6 rt-space-bottom rt-col-md-3">
                    <rt-card>
                      <template slot="header">
                        <img class="rt-card__header__image" src="https://www.old.rt.ru/data/img/logo-drweb.png"/>
                  ...
                  <rt-filter-watcher :options="['creator','count','subscription']"
                                     :values="['eset','less than 4','only month']"
                                     class="rt-col-6 rt-space-bottom rt-col-md-3">
                    <rt-card>
                      <template slot="header">
                  ...
                  <rt-filter-watcher :options="['creator','count','subscription']"
                                     :values="['eset','less than 4','not month']"
                                     class="rt-col-6 rt-space-bottom rt-col-md-3">
                    <rt-card>
                      <template slot="header">
                        <img class="rt-card__header__image" src="/sites/default/files/internet/ESET_color.svg"/>
                  ...
                  <rt-filter-watcher :options="['creator','count','subscription']"
                                     :values="['eset','less than 6','only month']"
                                     class="rt-col-6 rt-space-bottom rt-col-md-3">
                    <rt-card>
                      <template slot="header">
                        <img class="rt-card__header__image" src="/sites/default/files/internet/ESET_color.svg"/>
                  ...
                  <rt-filter-watcher :options="['creator','count','subscription']"
                                     :values="['eset','less than 6','not month']"
                                     class="rt-col-6 rt-space-bottom rt-col-md-3">
                    <rt-card>
                      <template slot="header">
                        <img class="rt-card__header__image" src="/sites/default/files/internet/ESET_color.svg"/>
                  ...
                  <rt-filter-watcher :options="['creator','count','subscription']" :values="['eset','1','only month']"
                                     class="rt-col-6 rt-space-bottom rt-col-md-3">
                    <rt-card>
                      <template slot="header">
                        <img class="rt-card__header__image" src="/sites/default/files/internet/ESET_color.svg"/>
            ...
            <rt-popup popup-wrapper-classes="rt-col-3" popup-classes="rt-col-td-3 rt-col-md-3" :show-on-desctop="false"
                      name="filter">
              ...
              <rt-sticky class="rt-popup-content">
                ...
                <div class="rt-space-bottom">
                  ...
                  <rt-filter-caller :clear-zero="true">
                    <rt-input name="count" value="1" :show-nubmers-buttons="true" insert-type="number" :min-number="1"
                              :max-number="10"/>
                  </rt-filter-caller>
                </div>
                <rt-filter-caller>
