            ...
            <div class="row">
              <div class="rt-col-6 rt-col-td-6 rt-col-md-3">
                <rt-table :no-borders="true">
                  <template slot="label">Разговоры без границ</template>
                  <template slot="columns">
                    <rt-table-col></rt-table-col>
                    <rt-table-col width="20%"></rt-table-col>
                  </template>
                  <template slot="description">
                    <p class="rt-font-paragraph rt-space-bottom2">Опция «Разговоры без границ» позволяет воспользоваться льготными
                    ценами на входящие звонки за пределами России.</p>
                  </template>
                  <template slot="body">
                    <rt-table-row>
                      <rt-table-item>Абонентская плата</rt-table-item>
                      <rt-table-item>5 ₽/сут.</rt-table-item>
                    </rt-table-row>
                    <rt-table-row>
                    ...
                    <rt-table-row>
                      <rt-table-item>Все входящие вызовы</rt-table-item>
                      <rt-table-item>5 ₽/мин.</rt-table-item>
                    </rt-table-row>
                  </template>
                </rt-table>
                <div class="d-inline-block rt-space-top3 rt-space-right4 rt-space-bottom2">
                  <h4 class="rt-font-bold">*100*352*1#</h4>
                  <p class="rt-font-center">подключение</p>
                </div>
                <div class="d-inline-block">
                  <h4 class="rt-font-bold">*100*352*0#</h4>
