  ...
  <div>
    <div class="rt-container">
      ...
      <div class="app-content rt-col-12 rt-col-md-3">
        <div class="app-title">
          <div class="row"><h1 class="rt-font-hero rt-col">TariffCards</h1></div>
        </div>
      </div>
    </div>
    <div class="rt-container">
      <div class="rt-col-12 rt-space-bottom2">
        <div class="rt-space-bottom is-b2c">
          <div class="row">
              ...
              <rt-tariff-card :has-seal="true" color="b2c-purple">
                  ...
                  <div class="rt-space-top-half">
                    <div class="d-flex flex-start-center rt-tariff-item">
                      ...
                      <div class="rt-space-left05">
                        ...
                        <p class="rt-font-control color-dark07 rt-font-dashed rt-slide-content-trigger">128 канала</p>
                      </div>
                    </div>
                  </div>
                  </template>
                ...
                <div class="rt-space-top-half">
                  <div class="d-flex flex-start-center rt-tariff-item rt-tariff-item--is-disabled">
                    ...
                    <svg width="19px" height="33px" viewBox="0 0 19 33" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="rt-col-3 rt-col-md-3 rt-space-top">
              <rt-tariff-card :has-seal="true" color="b2c-red"></rt-tariff-card>
            </div>
            <div class="rt-col-3 rt-col-md-3 rt-space-top">
              <rt-tariff-card :has-seal="true" color="b2c-yellow"></rt-tariff-card>
            </div>
            <div class="rt-col-3 rt-col-md-3 rt-space-top">
              <rt-tariff-card :has-seal="true"></rt-tariff-card>
            </div>
          </div>
          <div class="row">
            <div class="rt-col-3 rt-col-md-3 rt-space-top">
            ...
            <div class="rt-col-3 rt-col-md-3 rt-space-top">
              <rt-tariff-card discount="200%"></rt-tariff-card>
            </div>
          </div>
