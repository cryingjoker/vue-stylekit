<template>
  <div class="color-line-wrapper">
    <p class="rt-font-banner-label-bold color-line">
      <span :class="fillColorClass" class="color-line-text"
        ><slot name="label"
      /></span>
    </p>
    <p class="color-line color-line--is-paragraph rt-space-bottom">
      <span :class="fillColorClass" class="color-line-text rt-font-paragraph"
        ><slot name="content"/>
        <svg
          :class="colorLineIconClass"
          class="color-line-paragraph-icon"
          width="38"
          height="23"
        >
          <defs>
