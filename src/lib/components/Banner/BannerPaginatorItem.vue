<template>
  <div :class="paginatorItemClass" :style="paginatorItemStyle" class="circle-switcher__item" @click="setActiveItem">
    <svg :class="paginatorItemIconClass" xmlns="http://www.w3.org/2000/svg" class="circle-switcher__icon" viewBox="0 0 9 9">
