    ...
    <div v-if="showCodeEditor" class="code-editor">
      <div class="code-editor__close" @click="close()">
        <svg viewBox="0 0 14 14" class="code-editor__icon" xmlns="http://www.w3.org/2000/svg">
          ...
          9.44771525 19,10 L19,17 Z" fill-rule="evenodd" transform="rotate(45 25.778 -.778)"
          />
        </svg>
      </div>
      <pre-code-editor :code="normalizeCode.template" @change="changeComponentCode($event)" />
    </div>
