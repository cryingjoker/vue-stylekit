<template>
    <div class="app-content col-md-3  col-10">
        <div class="app-title">
                <h1 class="rt-font-hero row">Input</h1>
        </div>
        <div class="app-body">
            <div class="app-row row">
                <p class="rt-font-h3 col">Input without js</p>
            </div>
            <div class="app-row row">
                ...
                <div class="col-4 col-md-3 rt-mb-space-top">
            ...
            <div class="app-row row">
                <p class="rt-font-h3 col">Input with js</p>
            </div>
            <div class="app-row row">
