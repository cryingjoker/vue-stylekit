    ...
    <div>
                        ...
                        <div class="row">
                            <div class="rt-col-8">
                                <div class="rt-scroll-tab-nav">
                                    <a class="rt-scroll-tab-header__item" href="#about">О системе</a>
                                    <a class="rt-scroll-tab-header__item" href="#device">Устройства</a>
                                    <a class="rt-scroll-tab-header__item" href="#connect">Подключение и управление</a>
                                </div>
                            </div>
        ...
        <div class="color-block--light-grey" id="device">
            <div class="rt-container rt-space-vertical">
                <div class="row">
                    <div class="rt-col-12 rt-font-paragraph">
        ...
        <div class="color-block--rule-color">
            <div class="rt-container rt-space-top2 rt-space-bottom">
                <div class="rt-col-12">
                    ...
                    <div class="rule">
                        <p class="rule-item"> 1. Услуги Высокоскоростного интернета предоставляются при наличии
                            технической возможности.</p>
                        <p class="rule-item"> 2. Цены указаны в рублях с учетом НДС.</p>
                        <p class="rule-item"> «По оптической линии» — предоставление доступа к сети Интернет
                            ...
                            абонента).</p>
                        <p class="rule-item"> «По телефонной линии» — предоставление доступа к сети Интернет
                            осуществляется по технологии xDSL (англ., digital subscriber line, цифровая абонентская
                            линия).</p>
                        <p class="rule-item"> 3. Предоставление доступа к сети Интернет осуществляется по технологии
                            xDSL (англ., digital subscriber line, цифровая абонентская линия).</p>
                        <p class="rule-item"> 4. Скорость доступа к сети Интернет зависит не только от технических
                        ...
                        <p class="rule-item"> 5. Абонентская плата за услугу Интернет списывается с лицевого счета
                        ...
                        <p class="rule-item"> 6. Оборудование (маршрутизатор или абонентский модем в зависимости от
                            ...
                            8-800-100-0-800.</p>
                        <p class="rule-item"> 7. Safe Kids — Сэйф кидс (перевод с англ. — Защищенные дети). Услуга
...
<script>
  import { Button, ScrollTabs, Price, Tabs, TabsContentItem, TabsNavigationItem } from "@/components/main-elements";
